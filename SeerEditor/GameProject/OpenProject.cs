...
using SeerEditor.Utilities;

//Get and store info on projects we have previously created and open the selected one
namespace SeerEditor.GameProject
{
    [DataContract]
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\SeerEditor";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Seer\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Seer\Screenshot.png");
